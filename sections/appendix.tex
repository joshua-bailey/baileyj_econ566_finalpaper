...
\endfirsthead % Ensures the header is repeated on each page if the table spans multiple pages

\multicolumn{7}{c}%
{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\
\endhead % Header to be printed at the top of every subsequent page

\multicolumn{7}{r}{\textit{Continued on next page}} \\ \endfoot
\hline
\endlastfoot

\multicolumn{7}{c}{\textbf{Group 1: Output and Income}} \\ % Centered group title
\hline & id & tcode & fred & description & gsi & gsi:description \\ % Column headers
\hline 
...
\begin{longtable}{rlrllll}
\hline & id & tcode & fred & description & gsi & gsi:description \\
\hline 1 & 84 & 2 & FEDFUNDS & Effective Federal Funds Rate & M_110155157 & Fed Funds \\
 ...
 4 & 87 & 2 & TB6MS & 6-Month Treasury Bill: & M_110155166 & $6 \mathrm{mo}$ T-bill \\
 ...
 12 & 95 & 1 & TB6SMFFM & 6-Month Treasury C Minus FEDFUNDS & & $6 \mathrm{mo}-\mathrm{FF}$ spread \\
...
\setcounter{table}{7} % Set the table counter to 1 less than the actual number of tables
